...
COMMENT ON COLUMN "MEMBER"."MEMBER_TEL" IS '회원 휴대폰 번호(- 없음)';
...
COMMENT ON COLUMN "MEMBER"."MEMBER_DEL_FL" IS '회원 탈퇴 여부(N: 탈퇴X, Y: 탈퇴O)';
...
CREATE TABLE "BOARD" (
	...
	"B_UPDATE_DATE"	DATE	DEFAULT SYSDATE	NULL,
...
COMMENT ON COLUMN "BOARD"."B_CREATE_DATE" IS '게시글 작성일(B=BOARD)';

COMMENT ON COLUMN "BOARD"."B_UPDATE_DATE" IS '게시글 마지막 수정일(수정시 UPDATE)';

COMMENT ON COLUMN "BOARD"."READ_COUNT" IS '게시글 조회수';

COMMENT ON COLUMN "BOARD"."BOARD_DEL_FL" IS '게시글 삭제 여부( N: 삭제 X, Y: 삭제 O)';
...
COMMENT ON COLUMN "BOARD_IMG"."IMG_RENAME" IS '변경된 이미지 파일명';

COMMENT ON COLUMN "BOARD_IMG"."IMG_ORIGINAL" IS '원본 이미지 파일명';

COMMENT ON COLUMN "BOARD_IMG"."IMG_ORDER" IS '이미지 파일 순서 번호';

COMMENT ON COLUMN "BOARD_IMG"."BOARD_NO" IS '이미지 첨부 게시글 번호';
...
COMMENT ON COLUMN "COMMENT"."C_CREATE_DATE" IS '댓글 작성일(C = COMMENT)';

COMMENT ON COLUMN "COMMENT"."COMMENT_DEL_FL" IS '댓글 삭제 여부';

COMMENT ON COLUMN "COMMENT"."BOARD_NO" IS '댓글 작성 게시글 번호';

COMMENT ON COLUMN "COMMENT"."MEMBER_NO" IS '댓글 작성 회원 번호';

COMMENT ON COLUMN "COMMENT"."PARENT_NO" IS '부모 댓글 번호(대댓글 시)';
...
-- 시퀀스 생성
CREATE SEQUENCE SEQ_MEMBER_NO NOCACHE; -- 회원 번호 생성 시퀀스
CREATE SEQUENCE SEQ_BOARD_NO NOCACHE; -- 게시글 번호 생성 시퀀스
CREATE SEQUENCE SEQ_IMG_NO NOCACHE; -- 게시글 이미지 번호 생성 시퀀스
CREATE SEQUENCE SEQ_COMMENT_NO NOCACHE; -- 댓글 번호 생성 시퀀스

CREATE SEQUENCE SEQ_BOARD_CODE NOCACHE; -- 게시판 종류 코드 번호 생성 시퀀스
